...
**[To-Do list]** is a website that allows users to add and remove tasks from a list.
...
This project is [MIT](https://github.com/brighton0102/todo_list/blob/main/LICENSE) licensed.
